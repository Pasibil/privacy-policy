...
The application uses Firebase for services such as authentication, notifications, and backend functionality.

Firebase may process limited technical information including:

- device information  
- authentication identifiers (if login is used)  
...
RevenueCat may process limited purchase-related information such as:
